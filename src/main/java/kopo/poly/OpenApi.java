...
public class OpenApi {
    public static void main(String[] args) throws IOException {
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "52f466fb-3e57-463e-9753-d935bd9505b3"); /*서비스키*/
        ...
        urlBuilder.append("&" + URLEncoder.encode("schNm","UTF-8") + "=" + URLEncoder.encode("학교명(필수값, 2자이상)", "UTF-8")); /*학교명(필수값, 2자이상)*/
